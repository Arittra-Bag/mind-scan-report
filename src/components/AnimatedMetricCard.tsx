  ...
  return (
    <Card 
      className={cn(
        ...
        "bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm border-white/20",
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-transparent to-blue-50/20 transform group-hover:scale-110 transition-transform duration-700" />
